...
tumbler_prod_ef = 0.91412562    # 텀블러 생산
...
if show_result:
    ...
    st.markdown(
        ...
        - 최소 재사용 횟수는 **같은 횟수만큼 사용할 때 텀블러가 일회용 컵보다 유리해지는 기준점**입니다. 예를 들어 최소 재사용 횟수가 50회라면, 텀블러를 45회 사용할 경우에는 일회용 컵을 45회 사용하는 것이 더 나을 수 있습니다.  
        """
    )
