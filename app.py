...
if show_result:
    ...
    st.markdown(
        ...
        - 제시된 최소 재사용 횟수는 **텀블러 1개를 해당 횟수 이상 사용해야 같은 횟수의 일회용 컵을 사용하는 것보다 환경적으로 유리해진다**는 의미입니다. 즉, 그 횟수에 도달하기 전까지는 텀블러 생산 과정의 초기 환경부하가 커서 차라리 일회용 컵을 사용하는 것이 더 나을 수 있습니다.  
